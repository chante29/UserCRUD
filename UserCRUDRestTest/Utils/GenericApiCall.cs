...
namespace UserCRUDRestTest.Utils
{
    ...
    public class GenericApiCall
    {
        ...
        /// <summary>
        /// Launch a specific HttpRequestMessage
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
        public T LaunchTest<T>(HttpRequestMessage request)
        {
            var client = new HttpClient();
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public void LaunchTest(HttpRequestMessage request)
        {
            var client = new HttpClient();
            using (HttpResponseMessage response = client.SendAsync(request).Result)
            {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public void LaunchFailTest<T>(ObjectGenericApiCall request, T jsonObject)
        {
            var client = new HttpClient();
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public void LaunchNonFoundTest(ObjectGenericApiCall request)
        {
            var client = new HttpClient();
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public void LaunchNonFoundTest<T>(ObjectGenericApiCall request, T jsonObject)
        {
            var client = new HttpClient();
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public void LaunchUnauthorizedTest<T>(ObjectGenericApiCall request, T jsonObject)
        {
            var client = new HttpClient();
        ...
        public void LaunchUnauthorizedTest(ObjectGenericApiCall request)
        {
            var client = new HttpClient();
        ...
        public void LaunchConflictTest(ObjectGenericApiCall request)
        {
            var client = new HttpClient();
        ...
        public void LaunchConflictTest<T>(ObjectGenericApiCall request, T jsonObject)
        {
            var client = new HttpClient();
